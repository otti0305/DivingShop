      ...
      <div class="swiper js-mv-swiper mv__swiper">
        <div class="swiper-wrapper">
          <div class="swiper-slide mv__slide">
            <picture>
              <source media="(min-width: 768px)" srcset="<?php echo get_theme_file_uri(); ?>/images/common/mv-pc1.png">
              <img src="<?php echo get_theme_file_uri(); ?>/images/common/mv-sp1.png" alt="海亀の画像">
            </picture>
          </div>
          <div class="swiper-slide mv__slide">
            <picture>
              <source media="(min-width: 768px)" srcset="<?php echo get_theme_file_uri(); ?>/images/common/mv-pc2.png">
              <img src="<?php echo get_theme_file_uri(); ?>/images/common/mv-sp2.png" alt="海中の画像">
            </picture>
          </div>
          <div class="swiper-slide mv__slide">
            <picture>
              <source media="(min-width: 768px)" srcset="<?php echo get_theme_file_uri(); ?>/images/common/mv-pc3.png">
              <img src="<?php echo get_theme_file_uri(); ?>/images/common/mv-sp3.png" alt="海辺の画像">
            </picture>
          </div>
          <div class="swiper-slide mv__slide">
            <picture>
              <source media="(min-width: 768px)" srcset="/assets/images/common/mv-pc4.png">
              <img src="<?php echo get_theme_file_uri(); ?>/images/common/mv-sp4.png" alt="砂浜の画像">
            </picture>
          </div>
        </div>
      </div>
          ...
          <div class="swiper campaign__swiper js-campaign-swiper">
            <div class="swiper-wrapper campaign-cards">
              <div class="swiper-slide campaign-cards__item">
                <a href="#" class="campaign-card">
                  <div class="campaign-card__img">
                    <img src="<?php echo get_theme_file_uri(); ?>/images/common/campaign1.png" alt="campaignのイメージ写真">
                  </div>
              ...
              <div class="swiper-slide campaign-cards__item">
                <a href="#" class="campaign-card">
                  <div class="campaign-card__img">
                    <img src="<?php echo get_theme_file_uri(); ?>/images/common/campaign2.png" alt="campaignのイメージ写真">
                  </div>
                  <div class="campaign-card__body">
                    <div class="campaign-card__head">
              ...
              <div class="swiper-slide campaign-cards__item">
                <a href="#" class="campaign-card">
                  <div class="campaign-card__img">
                    <img src="<?php echo get_theme_file_uri(); ?>/images/common/campaign3.png" alt="campaignのイメージ写真">
                  </div>
                  <div class="campaign-card__body">
                    <div class="campaign-card__head">
                      <div class="campaign-card__category">体験ダイビング</div>
              ...
              <div class="swiper-slide campaign-cards__item">
                <a href="#" class="campaign-card">
                  <div class="campaign-card__img">
                    <img src="<?php echo get_theme_file_uri(); ?>/images/common/campaign4.png" alt="campaignのイメージ写真">
                  </div>
                  <div class="campaign-card__body">
                    <div class="campaign-card__head">
      ...
      <div class="information__inner inner">
        ...
        <div class="information__content">
          <div class="information__img box">
            <img src="<?php echo get_theme_file_uri(); ?>/images/common/information.png" alt="informationのイメージ写真">
          </div>
      ...
      <div class="blog__inner inner">
        ...
        <div class="blog__cards blog-cards">
          <div class="blog-cards__item">
            <a href="#" class="blog-card">
              <div class="blog-card__img">
                <img src="<?php echo get_theme_file_uri(); ?>/images/common/blog-img1.jpg" alt="ライセンス取得">
              </div>
          ...
          <div class="blog-cards__item">
            <a href="#" class="blog-card">
              <div class="blog-card__img">
                <img src="<?php echo get_theme_file_uri(); ?>/images/common/blog-img2.jpg" alt="ライセンス取得">
              </div>
              <div class="blog-card__body">
                <div class="blog-card__date">
                  <time datetime="2024-10-27T19:00">2023/11/17</time>
          ...
          <div class="blog-cards__item">
            <a href="#" class="blog-card">
              <div class="blog-card__img">
                <img src="<?php echo get_theme_file_uri(); ?>/images/common/blog-img3.jpg" alt="ライセンス取得">
              </div>
              <div class="blog-card__body">
                <div class="blog-card__date">
                  <time datetime="2024-10-27T19:00">2023/11/17</time>
            ...
            <a href="#" class="voice-card">
              <div class="voice-card__head">
                ...
                <div class="voice-card__img box">
                  <img src="<?php echo get_theme_file_uri(); ?>/images/common/voice-img1.jpg" alt="女性の写真">
                </div>
              </div>
          ...
          <div class="voice-cards__item">
            <a href="#" class="voice-card">
              <div class="voice-card__head">
                ...
                <div class="voice-card__img box">
                  <img src="<?php echo get_theme_file_uri(); ?>/images/common/voice-img2.jpg" alt="男性の写真">
                </div>
              </div>
              <div class="voice-card__body">
                <div class="voice-card__text">ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。<br>
