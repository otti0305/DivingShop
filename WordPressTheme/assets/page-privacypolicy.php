...
<main>
  ...
  <div class="sub-mv">
    ...
    <div class="sub-mv__img">
      <picture>
        ...
        <img img src="<?php echo get_theme_file_uri(); ?>/images/common/sub-bg-sp.jpg" alt="海中を泳ぐ魚の群れ">
      </picture>
    </div>
  </div>
  ...
  <nav class="breadcrumb layout-breadcrumb">
    <div class="breadcrumb__inner inner">
      <ul class="breadcrumb__lists">
        ...
        <li class="breadcrumb__list">プライバシーポリシー</li>
      </ul>
    </div>
  </nav>
  ...
  <section class="proviso layout-proviso sub-illustration">
    <div class="proviso__inner inner">
      <h2 class="proviso__title">プライバシーポリシー</h2>
