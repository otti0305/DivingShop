  ...
  <div class="sub-campaign sub-campaign-layout sub-illustration">
    <div class="sub-campaign__inner inner">
      <div class="sub-campaign__tab">
        <ul class="tab">
          <li class="tab__list is-active"><a href="<?php echo get_post_type_archive_link('campaign') ?>">all</a></li>
          <?php $genre_terms = get_terms('genre' , array('hide_empty' =>false)); ?>
          <?php foreach($genre_terms as $genre_term) : ?>
            <li class="tab__list"><a href="<?php echo get_term_link($genre_term, 'genre'); ?>"><?php echo $genre_term->name; ?></a></li>
          <?php endforeach; ?>
        </ul>
      </div>
                ...
                <div class="sub-campaign-card__body">
                  ...
                  <div class="sub-campaign-card__price">
                   <?php if ( $catch = get_field('catch') ) : ?>
                    <p class="sub-campaign-card__catch"><?php echo esc_html($catch); ?></p>
                   <?php endif; ?>
