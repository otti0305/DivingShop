...
<main>
  ...
  <div class="sub-mv">
    ...
    <div class="sub-mv__img">
      <picture>
        <source media="(min-width: 768px)" srcset="<?php echo get_theme_file_uri(); ?>/images/common/faq-bg-pc.jpg">
        <img img src="<?php echo get_theme_file_uri(); ?>/images/common/faq-bg-sp.jpg" alt="海中を泳ぐ魚の群れ">
      </picture>
    </div>
  </div>
