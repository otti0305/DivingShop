  ...
  <div class="sub-mv">
    ...
    <div class="sub-mv__img">
      <picture>
        ...
        <img src="/assets/images/common/sub-voice-sp.jpg" alt="海中を泳ぐ魚の群れ">
      </picture>
    </div>
  </div>
  ...
  <div class="sub-voice sub-voice-layout sub-illustration">
    <div class="sub-voice__inner inner">
      <div class="sub-voice__tab">
        ...
        $genre_terms = get_terms('voice-genre', array('hide_empty' => false));
        ...
        ?>
          <li class="tab__list <?php echo $active_class; ?>">
            <a href="<?php echo get_term_link($genre_term, 'voice-genre'); ?>">
