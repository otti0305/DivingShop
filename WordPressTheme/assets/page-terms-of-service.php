...
<main>
  ...
  <div class="sub-mv">
    ...
    <div class="sub-mv__img">
      <picture>
        <source media="(min-width: 768px)" srcset="<?php echo get_theme_file_uri(); ?>/images/common/sub-bg-pc.jpg">
        <img src="<?php echo get_theme_file_uri(); ?>/images/common/sub-bg-sp.jpg" alt="海中を泳ぐ魚の群れ">
      </picture>
    </div>
  </div>
  ...
  <nav class="breadcrumb layout-breadcrumb">
    <div class="breadcrumb__inner inner">
      <ul class="breadcrumb__lists">
        ...
        <li class="breadcrumb__list"><img src="<?php echo get_theme_file_uri(); ?>/images/common/breadcrumb-arrow.png" alt=""></li>
        <li class="breadcrumb__list">利用規約</li>
      </ul>
    </div>
  </nav>

  <section class="proviso layout-proviso sub-illustration">
    <div class="proviso__inner inner">
      <h2 class="proviso__title">利用規約</h2>
      <div class="proviso__text-body">
        <?php if(have_posts()) :
          while(have_posts()) :
            the_post(); ?>
            <?php the_content(); ?>
